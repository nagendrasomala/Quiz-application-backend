...
student.post('/sregister', async (req, res) => {
  try {
    ...
    res.json({ username: savedUser.name, email: savedUser.email, password: savedUser.password });
  } catch (error) {
    console.error(error);
...
student.post('/slogin', async (req, res) => {
  try {
